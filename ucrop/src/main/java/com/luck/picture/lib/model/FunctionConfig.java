...
public class FunctionConfig implements Serializable {
    ...
    private int checkedBoxDrawable = R.drawable.ucrop_picturelib_checkbox_selector;// 图片选择默认样式
    ...
    protected int compressQuality = 70;// 图片裁剪质量,默认无损
    protected List<LocalMedia> selectMedia = new ArrayList<>();// 已选择的图片
    protected int compressFlag = 2; // 1 系统自带压缩 2 luban压缩
