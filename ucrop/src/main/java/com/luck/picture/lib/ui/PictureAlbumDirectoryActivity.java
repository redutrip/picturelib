...
public class PictureAlbumDirectoryActivity extends PictureBaseActivity implements View.OnClickListener, PictureAlbumDirectoryAdapter.OnItemClickListener, ObserverListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ucrop_picture_activity_album);
        ...
        switch (type) {
            case LocalMediaLoader.TYPE_IMAGE:
                picture_tv_title.setText(getString(R.string.ucrop_picturelib_select_photo));
                break;
            case LocalMediaLoader.TYPE_VIDEO:
                picture_tv_title.setText(getString(R.string.ucrop_picturelib_select_video));
                break;
        }
    ...
    protected void initData() {
        if (folders.size() > 0) {
            ...
            switch (type) {
                case LocalMediaLoader.TYPE_IMAGE:
                    tv_empty.setText(getString(R.string.ucrop_picturelib_no_photo));
                    break;
                case LocalMediaLoader.TYPE_VIDEO:
                    tv_empty.setText(getString(R.string.ucrop_picturelib_no_video));
                    break;
            }
        }
    }
    ...
    private void startEmptyImageActivity() {
        ...
        switch (type) {
            case LocalMediaLoader.TYPE_IMAGE:
                title = getString(R.string.ucrop_picturelib_lately_image);
                break;
            case LocalMediaLoader.TYPE_VIDEO:
                title = getString(R.string.ucrop_picturelib_lately_video);
                break;
        }
